...
puts
puts "Antes de iniciar este script, asegurese estar utilizando ruby 1.9.3, de tener instalado rubygems, bundler y de haber ejecutado \'bundle install\'"
...
if system("gem install bundler --no-rdoc --no-ri")
